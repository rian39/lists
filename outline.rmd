...
It was surprising that Shreena spoke relatively briefly about the new models. She showed a graph that compared the old rule-based model with some of the new alternatives -- logistic regression, random forests, and a few others. She dismissed most of the models quite quickly and focused only on one, the logistic regression model. Or more accurately, she just said that logistic regression did better than other, and there was little more to discusson on that front.     

Why did she say little about the model, which after all, produces the probabilistic predictions on which everything in the recommendation list depends? 

Her interest lay in the relevance of the recommendations, and in particular, in how 'basket similarity affects relevance of recommendations.' 
HERE
