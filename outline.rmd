...
So the raw data -- the 52 weeks of purchases for each customer -- can be aggregated in various ways to increase the density of the data in ways that helps the model. Shreena mentions some of the 'features' used in the new model --    
HERE
