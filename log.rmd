...
I went through the three reports, making many of the changes suggested. Many of these were useful and I was happy to respond to them. 

An overview of changes and discussion of suggestions I wasn't able to implement:
 - R1: 
     -  For reasons of word count, I wasn't able to include a detailed discussion of the Tesco user interface. Given my focus on propensities and ordering of recommendations, I wasn't sure that was so relevant. Footnote 3 has a description of how handwritten lists and writing lists have been understood by anthropologists and literary theorists. 
     - R1 asked for literature on adaptive ecommerce systems to be included, which is fine (I included the references), but I didn't discuss this very much. Grocery shopping, as I point in the introduction differs in important ways from many typical e-commerce settings. 
 - R2: 
    - to be honest, this was a difficult report to respond to. It occasioned me a lot of effort to deal with what seems a report coming from a very different starting point. I have tried, but it would require much more scaffolding to deal with them all. 
    ...
    - R2 was concerned about extremely confusing methodology. I've added a sentence or two in the methodology section saying what the paper does. But I won't, I fear, be able to assuage R2's concerns. They don't countenance what I'm trying to do: ground a theoretical argument by assembling some empirical engagements -- the ethnographic event, the small experiments with Tesco APIs and recommender system models, the existing sociologies and anthropologies of shopping and lists and the archaeology of recommendation. Its not a conventional empirical research project, and the methodology of reconstruction that I use (borrowing from Dewey) is unlikely to satisfy narrowly defined sociological requirements. Given the methodological pluralism of the journal, I'm hoping that this is ok. 
