...
I went through the three reports, making nearly all the changes suggested. Many of these were useful and I was happy to respond to them. 
Here are the ones I didn't do:
 - R1: For reasons of word count, I wasn't able to include a detailed discussion of the Tesco user interface. Given my focus on propensities and ordering of recommendations, I wasn't sure that was so relevant. Footnote 3 has a description of how handwritten lists and writing lists have been understood by anthropologists and literary theorists. 
 - R2: 
