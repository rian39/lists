...
- responding to R2 today; 
     ...
     paragraph setting out the structure of the paper:

     The argument develops in four main steps. The first main section introduces the case study -- the Tesco online grocery  recommender system as presented at an industry/academic conference. The second section frames grocery shopping in terms of sociological and anthropological accounts of shopping lists and social order, highlighting how both lists and shopping overflow individual identity. A brief archaeology of recommendation describes the shift from 1980s census-based data-mining to web-based recommender system at the turn of the century. The following section is the main body of the paper and approaches recommendations in terms of the different kinds of probability calculations that both target persons and somewhat overflow them. These range across calculations concerning the relation between products, between products and people,  
