...
I went through the three reports, making many of the changes suggested. Many of these were useful and I was happy to respond to them. The main change is the overview and summary of the paper. A new paragraph towards the end of the introduction sets out the argument step by step, and the steps of the argument are also reiterated in the conclusion. 

An overview of changes and discussion of suggestions I wasn't able to implement:
 - R1: 
     -  For reasons of word count, I wasn't able to include a detailed discussion of the Tesco user interface. Given my focus on probabilities, propensities and ordering of recommendations, I wasn't sure that was so relevant. Footnote 3 has a description of how handwritten lists and writing lists have been understood by anthropologists and literary theorists. 
 ...
 - R2: 
    ...
    - R2 was concerned about extremely confusing methodology. I've added a sentence or two in the methodology section saying what the paper does. But I won't, I fear, be able to assuage R2's concerns. They don't countenance what I'm trying to do: ground a theoretical argument about changing modes of operational knowledge by assembling some empirical engagements -- the ethnographic event, the small experiments with Tesco APIs and recommender system models, the existing sociologies and anthropologies of shopping and lists and the archaeology of recommendation. Its not a conventional empirical research project, and the methodology of reconstruction that I use (borrowing from Dewey) does not conform to narrowly defined sociological requirements. Given the methodological pluralism of the journal, I'm hoping that this is viable. 
...
- R3:
    - it was a relief to not have to do much in responding to this report. I was happy to expand the sentences about object-oriented research.  
