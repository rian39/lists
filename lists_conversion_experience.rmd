...
To this end, I will be seeking to simulate the workings of the recommender system by generating queries, and exploring results from  a very large supermarket chain database. 
...
A little history of recommender systems -- uses Varian 1997 for a start. But has no real reference list. 
...
Patel said that some people log on and go straight to the checkout, allowing the recommender system to supply them with the suggestions that they then move to the shopping basket.
