...
author: Adrian Mackenzie^[University of Somewhere] 
...
```{r random_basket, echo=FALSE, cache=TRUE, fig.cap='Random basket', fig.margin=TRUE}
=======
...
<<<<<<< HEAD
kable(sample_n(df, size=5)$name, col.names='Items')
```
...
inspect(rules[1:5]) 
rule2 = inspect(rules[2])
rule1 = inspect(rules[1])
