...
In this respect, the presentation was not really surprising or exceptional. Its ordinariness and prosaic character stands out as the most significant feature.  The presentation itself is a working example for an argument about our experience of predictive ordering. In this paper, I re-present the presentation using a mixture of theoretical and practical resources. The theory is largely recent media theory, and the practical resources are that of coding and predictive models.  
...
- how do things associate with each other in complementarities, substitutions, etc. 
